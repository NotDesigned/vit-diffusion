...
def compute_fid(model, scheduler, vae, num_samples, device, real_dataset_path, temp_dir='./temp_samples', mode='vit', strategy='sample'):
    """
    ...
    while generated_count < num_samples:
        ...
        for i in range(current_bs):
            ...
            save_image(images[i], os.path.join(temp_dir, f"{idx:05d}.png"), normalize=True, value_range=(-1, 1))
